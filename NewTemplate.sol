...
contract ERC20 is IERC20 {
    ...
    string public constant name = "CatThis";
    string public constant symbol = "CATS";
    uint8 public constant decimals = 18;
    address public contractOwner = msg.sender;
    uint public nodeRewardAmount = 50; // Setting the node reward amount to 50 on lanuch
    uint public nodeAmount = 1000; // We set the required amount of coins to be 1000.
